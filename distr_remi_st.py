...
# Configuration
configuration = {'config_project_name': 'Distributor', 'config_address': '0.0.0.0', 'config_port': 8085, 'config_multiple_instance': True, 'config_enable_file_cache': True, 'config_start_browser': True, 'config_resourcepath': './res/'}
